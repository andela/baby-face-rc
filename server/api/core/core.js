...
export default {
  ...
  defaultCustomerRoles: [ "guest", "account/profile", "category", "product", "tag", "index", "cart/checkout", "cart/completed"],
  defaultVisitorRoles: ["anonymous", "guest", "category", "product", "tag", "index", "cart/checkout", "cart/completed"],
  createGroups,
  /**
   * canInviteToGroup
