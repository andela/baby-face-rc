 ...
 * @property {Boolean} isDigital, default value: `false`
 * @property {String} digitalFileSize optional, default value: `0`
 * @property {String} digitalFileDownloadLink optional
...
export const ProductVariant = new SimpleSchema({
  ...
  isDigital: {
    label: "Indicates if a product is digital",
    type: Boolean,
    defaultValue: false
  },
  digitalFileSize: {
    label: "File size of the digital product",
    type: Number,
    optional: true,
    defaultValue: 0
  },
  digitalFileDownloadLink: {
    label: "Link to download the digital file",
    type: String,
    optional: true
  },
  isVisible: {
